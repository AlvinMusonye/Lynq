    ...
    <div className="min-h-screen bg-white overflow-x-hidden" style={{ fontFamily: 'Lora, serif' }}>
      ...
      <nav className="container mx-auto px-6 py-6 flex justify-between items-center rounded-2xl bg-white/50 backdrop-blur-md border border-white/20">
        ...
        <div className="flex gap-4 sm:gap-8 items-center text-sm">
          ...
          <a href="#how-it-works" className="hidden sm:inline-block text-gray-700 hover:text-orange-600 transition-colors">How it works</a>
          <button className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-6 py-2 rounded-full text-sm font-medium hover:shadow-lg transition-all hover:from-orange-700 hover:to-orange-600" onClick={onStart}>
            Start Cleaning
          </button>
        </div>
      </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-12">
              <button onClick={onStart} className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-8 py-4 rounded-full text-base font-medium hover:shadow-xl transition-all hover:from-orange-700 hover:to-orange-600">
                Start Cleaning
              </button>
              <button onClick={onStart} className="bg-white text-orange-600 px-8 py-4 rounded-full text-base font-medium border-2 border-orange-200 hover:border-orange-400 transition-all">
                Try Demo
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white rounded-3xl p-6 shadow-md border border-orange-100">
                <div className="bg-orange-50 rounded-2xl w-12 h-12 flex items-center justify-center mb-4 shadow-sm">
            ...
            <div className="relative z-10 mx-auto" style={{ width: '280px' }}>
              ...
              <div className="bg-gray-900 rounded-[3rem] p-3 shadow-2xl">
                <div className="bg-white rounded-[2.5rem] overflow-hidden">
                  ...
                  {/* Screen Content */}
                  <div className="bg-gradient-to-br from-orange-50 to-white px-4 py-4" style={{ height: '520px' }}>
                    {/* Header */}
                    <div className="mb-4">
                      ...
                      {/* Primary Card */}
                      <div className="bg-gradient-to-br from-orange-600 to-orange-500 rounded-2xl p-4 text-white shadow-lg">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-600 mb-2">Save Hours</div>
            <div className="text-gray-600">of manual cleaning</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-600 mb-2">Zero Errors</div>
            <div className="text-gray-600">Eliminate human mistakes</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-600 mb-2">Any Size</div>
            <div className="text-gray-600">Works with large CSV files</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-600 mb-2">Easy to Use</div>
      ...
      <section id="features" className="bg-gradient-to-br from-orange-50 to-white py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Comprehensive <span className="bg-gradient-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent">Feature Set</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto items-center">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-orange-600 to-orange-500 rounded-3xl p-8 text-white shadow-xl">
                <div className="flex items-center gap-3 mb-4">
                  <Download className="w-8 h-8" />
                  <h3 className="text-2xl font-bold">One-Click Export</h3>
                </div>
                <p className="text-orange-100 mb-6">Download a clean, ready-to-use CSV instantly. No hassle, no waiting.</p>
              ...
              <div className="bg-white/60 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-white/20">
                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl p-3">
                ...
                <div className="flex gap-2">
                  <div className="px-4 py-2 bg-orange-100 text-orange-600 rounded-full text-sm font-medium">Web-based</div>
      ...
      <section id="how-it-works" className="container mx-auto px-6 py-16 md:py-20">
        <div className="text-center mb-16">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg">
              <div className="bg-gradient-to-br from-orange-600 to-orange-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold shadow-lg">
                1
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-lg">
              ...
              <Wand2 className="w-12 h-12 text-orange-600 mx-auto mb-4" />
      ...
      <section className="container mx-auto px-6 py-16 md:py-20">
        <div className="bg-gradient-to-br from-orange-600 to-orange-500 rounded-[3rem] overflow-hidden relative">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center p-8 md:p-12 lg:p-20">
            {/* Left Content */}
            <div className="text-white">
              ...
              <button onClick={onStart} className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold hover:shadow-2xl transition-all">
                Start Cleaning →
              </button>
            </div>
              ...
              <div className="relative z-10" style={{ width: '240px', margin: '0 auto' }}>
                <div className="bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl">
                  <div className="bg-white rounded-[2rem] overflow-hidden">
                    <div className="bg-gradient-to-br from-orange-50 to-white p-6" style={{ height: '480px' }}>
                      <div className="text-center mb-6">
                        <div className="w-16 h-16 bg-gradient-to-br from-orange-600 to-orange-400 rounded-full mx-auto mb-3 flex items-center justify-center">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-white rounded-2xl p-4 shadow-sm border border-orange-200">
                          <div className="flex items-center gap-2 mb-1">
                        ...
                        <div className="bg-white/70 backdrop-blur-md rounded-2xl p-4 shadow-sm border border-white/20">
                          ...
                          <div className="text-xs text-orange-600">Click to download</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      {/* Footer */}
      <footer className="bg-[rgb(201,209,241)] text-gray-800 py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400 text-sm">
                <div><a href="#features" className="text-gray-700 hover:text-gray-900 transition-colors">Features</a></div>
                <div><a href="#how-it-works" className="text-gray-700 hover:text-gray-900 transition-colors">How It Works</a></div>
                <div><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Docs</a></div>
              </div>
            </div>
            <div>
              <h4 className="font-bold mb-4">Company</h4>
              <div className="space-y-2 text-gray-400 text-sm">
                <div><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Contact</a></div>
                <div><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">GitHub</a></div>
              </div>
            </div>
            <div>
              <h4 className="font-bold mb-4">Legal</h4>
              <div className="space-y-2 text-gray-400 text-sm">
                <div><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Privacy Policy</a></div>
                <div><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors">Terms of Service</a></div>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-700 pt-8 text-center text-gray-700 text-sm">
            <p>&copy; 2025 Lynq. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
